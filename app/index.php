					...
					<div id="userDetailsMessage"></div>
					 <form>
						...
						<div class="form-group col-md-8">
							...
							<select id="userRole" name="userRole" class="form-control chosenSelect">
									<?php include('inc/roleList.html'); ?>
							</select>
						</div>
						<div class="form-group col-md-8">
							<label for="userStatus">Status</label>
							<select id="userStatus" name="userStatus" class="form-control chosenSelect">
								<?php include('inc/statusList.html'); ?>
							</select>
						</div>
						</div>
