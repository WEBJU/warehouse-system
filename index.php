<?php
	...
	require_once('app/inc/config/constants.php');
	require_once('app/inc/config/db.php');
		...
		<div class="card">
		  ...
		  <div class="card-body">
			...
			<div id="loginMessage"></div>
			  ...
			  <a href="app/login.php?action=register" class="btn btn-success">Register</a>
			  <a href="app/login.php?action=resetPassword" class="btn btn-warning">Reset Password</a>
			  <button type="reset" class="btn">Clear</button>
			</form>
		  </div>
		</div>
